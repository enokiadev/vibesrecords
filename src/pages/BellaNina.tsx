...
const BellaNina = () => {
    return (
        <div className="pt-20 min-h-screen bg-background">
            ...
            {/* Social Feed Section */}
            <section className="py-20 container mx-auto px-4">
                <h2 className="text-3xl font-bold text-white mb-12 text-center">Trending on TikTok</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        { img: '/assets/Bella-nina-ticktock-snap.png', title: 'Tick Tock' },
                        { img: '/assets/Bella-nina-bubblegum-snap.png', title: 'Bubble Gum' },
                        { img: '/assets/Bella-nina-limitless-snap.png', title: 'Limitless' },
                        { img: '/assets/Bella-nina-thank-God-snap.png', title: 'Thank God' }
                    ].map((item, index) => (
                        <a
                            key={index}
                            href="https://tiktok.com/@iambellanina"
                            target="_blank"
                            rel="noreferrer"
                            className="aspect-[9/16] rounded-xl overflow-hidden relative group border border-white/10 hover:border-primary/50 transition-all"
                        >
                            <img
                                src={item.img}
                                alt={item.title}
                            ...
                            <div className="absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/40 transition-colors">
                                <svg className="h-12 w-12 text-white opacity-0 group-hover:opacity-100 group-hover:scale-110 transition-all" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" />
                                </svg>
                            </div>
                            <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                                <p className="text-white text-sm font-medium truncate">{item.title} ✨ #BellaNina</p>
                            </div>
                        </a>
                    ))}
                </div>
